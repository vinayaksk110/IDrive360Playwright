...
public class UpdateFirstNameFromNameEdit extends TestBase {
	...
	public UpdateFirstNameFromNameEdit() {

	}

	public UpdateFirstNameFromNameEdit(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(UpdateFirstNameFromNameEdit.class.getSimpleName());
	}
	...
	public void startTest() {
		...
		logicForUpdateFirstNameFromNameEdit(pageObjectManager.getUserCredentials().userToBeEdited);

	}

	public TestResultsStatus logicForUpdateFirstNameFromNameEdit(String userEmail) {
		...
		try {
			...
			try {
				pageObjectManager.getUsersPage().clickOnNameEditIcon(userEmail, testResultsStatus);
