...
public class AddBackupUserInDefaultCompany extends TestBase {
	...
	public AddBackupUserInDefaultCompany() {

	}

	public AddBackupUserInDefaultCompany(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(AddBackupUserInDefaultCompany.class.getSimpleName());
	...
	public void startTest() {
		...
		logicForAddBackupUserInDefaultCompany();

	}

	public TestResultsStatus logicForAddBackupUserInDefaultCompany() {
