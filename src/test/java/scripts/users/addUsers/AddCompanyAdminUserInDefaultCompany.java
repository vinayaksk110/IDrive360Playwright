...
public class AddCompanyAdminUserInDefaultCompany extends TestBase {
	UserCredentials userCredentials = null;
	PageObjectManager pageObjectManager = null;
	WebDriver driver = null;
	Wait<WebDriver> wait = null;

	public AddCompanyAdminUserInDefaultCompany() {

	}

	public AddCompanyAdminUserInDefaultCompany(PageObjectManager pageObjectManager, WebDriver driver,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(AddCompanyAdminUserInDefaultCompany.class.getSimpleName());
	...
	public void startTest() {
		...
		try {
			userCredentials = localExcelUtility.getCompleteSheetData(getWorkbookPath_AccountsForTesting(), "Users",
					"AddCompanyAdminUserInDefaultCompany");
		...
		logicForAddCompanyAdminUserInDefaultCompany();

	}

	public TestResultsStatus logicForAddCompanyAdminUserInDefaultCompany() {
