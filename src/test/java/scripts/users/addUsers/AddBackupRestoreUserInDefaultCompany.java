...
public class AddBackupRestoreUserInDefaultCompany extends TestBase {
	...
	public AddBackupRestoreUserInDefaultCompany() {

	}

	public AddBackupRestoreUserInDefaultCompany(PageObjectManager pageObjectManager, WebDriver driver,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(AddBackupRestoreUserInDefaultCompany.class.getSimpleName());
	}
	...
	public void startTest() {
		...
		try {
			...
			userCredentials = localExcelUtility.getCompleteSheetData(getWorkbookPath_AccountsForTesting(), "Users",
					"AddBackupRestoreUserInDefaultCompany");
		...
		logicForAddBackupRestoreUserInDefaultCompany();

	}

	public TestResultsStatus logicForAddBackupRestoreUserInDefaultCompany() {
	...
	public void endTest() {
		...
		try {
			...
			log.info("Reached exception while writing testresults.");
			e.printStackTrace();
