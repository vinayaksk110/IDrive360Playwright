...
public class AddRestoreUserInDefaultCompany extends TestBase {
	...
	public AddRestoreUserInDefaultCompany() {

	}

	public AddRestoreUserInDefaultCompany(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(AddRestoreUserInDefaultCompany.class.getSimpleName());
	}
	...
	public void startTest() {
		...
		try {
			userCredentials = localExcelUtility.getCompleteSheetData(getWorkbookPath_AccountsForTesting(), "Users",
					"AddRestoreUserInDefaultCompany");
		...
		logicForAddRestoreUserInDefaultCompany();

	}

	public TestResultsStatus logicForAddRestoreUserInDefaultCompany() {
		...
		try {
			...
			// wait.until(ExpectedConditions.visibilityOf(pageObjectManager.getUsersPage()..byDefaultUnitAdmInRolesCheckbox));
			...
			// Checking checkbox - Restore user Role
