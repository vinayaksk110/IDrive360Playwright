...
public class AddBackupAdminUserInDefaultCompany extends TestBase {
	...
	public AddBackupAdminUserInDefaultCompany() {

	}

	public AddBackupAdminUserInDefaultCompany(PageObjectManager pageObjectManager, WebDriver driver,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(AddBackupAdminUserInDefaultCompany.class.getSimpleName());
	}
	...
	public void startTest() {
		...
		try {
			userCredentials = localExcelUtility.getCompleteSheetData(getWorkbookPath_AccountsForTesting(), "Users",
					"AddBackupAdminUserInDefaultCompany");
		...
		logicForAddBackupAdmUserInDefaultCompany();

	}

	public TestResultsStatus logicForAddBackupAdmUserInDefaultCompany() {
		...
		try {
			...
			// Checking checkbox - Backup Admin Role
			...
			String errorMessage = "Error while adding user\n";
			testResultsStatus.setTestResult("Fail");
