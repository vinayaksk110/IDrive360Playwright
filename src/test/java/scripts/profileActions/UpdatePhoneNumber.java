...
public class UpdatePhoneNumber extends TestBase {
	...
	public UpdatePhoneNumber(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(UpdatePhoneNumber.class.getSimpleName());
	}

	@Test
	public void runUpdatePhoneNumber() {
		...
		logicForUpdatePhoneNumber();

	}

	public TestResultsStatus logicForUpdatePhoneNumber() {
		...
		try {
			...
			wait.until(ExpectedConditions.visibilityOf(pageObjectManager.getAccountPage().inputPhoneNumber));
			pageObjectManager.getAccountPage().inputPhoneNumber.click();
			pageObjectManager.getAccountPage().inputPhoneNumber.clear();
			pageObjectManager.getAccountPage().inputPhoneNumber(pageObjectManager.getUserCredentials().phoneNoToUpdate);
			log.info("Passed Phone number to be updated");
