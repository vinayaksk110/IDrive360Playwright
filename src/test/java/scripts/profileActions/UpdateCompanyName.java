...
public class UpdateCompanyName extends TestBase {
	...
	public UpdateCompanyName(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(UpdateCompanyName.class.getSimpleName());
	}

	@Test
	public void runUpdateCompanyName() {
		...
		logicForUpdateCompanyName();

	}

	public TestResultsStatus logicForUpdateCompanyName() {
		...
		try {
			...
			pageObjectManager.getAccountPage().inputCompanyName.click();
			pageObjectManager.getAccountPage().inputCompanyName.clear();
			pageObjectManager.getAccountPage()
					.inputCompanyName(pageObjectManager.getUserCredentials().companyNameToUpdate);
			log.info("Passed company name to be updated");
