...
public class UpdateLastName extends TestBase {
	...
	public UpdateLastName(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(UpdateLastName.class.getSimpleName());
	}

	@Test
	public void runUpdateLastName() {
		...
		logicForUpdateLastName();

	}

	public TestResultsStatus logicForUpdateLastName() {
		...
		try {
			...
			wait.until(ExpectedConditions.visibilityOf(pageObjectManager.getAccountPage().inputLastName));
			pageObjectManager.getAccountPage().inputLastName.click();
			pageObjectManager.getAccountPage().inputLastName.clear();
			pageObjectManager.getAccountPage().inputLastName(pageObjectManager.getUserCredentials().lastNameToUpdate);
			log.info("Passed last name to be updated");
