...
public class HeaderAddCompany extends TestBase {
	UserCredentials userCredentials = null;
	PageObjectManager pageObjectManager = null;
	WebDriver driver = null;
	Wait<WebDriver> wait = null;

	public HeaderAddCompany() {

	}

	public HeaderAddCompany(WebDriver driver, Wait<WebDriver> wait, PageObjectManager pageObjectManager,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(HeaderAddCompany.class.getSimpleName());
	}
	...
	public void startTest() {
		...
		logicForHeaderAddCompany();

	}

	public TestResultsStatus logicForHeaderAddCompany() {
		...
		try {
			...
			// Click Add button from header
			pageObjectManager.getHeaderFunctionalityPage().waitAndClickAddButtonFromHeader(testResultsStatus);
			// Add company button click
			try {
				pageObjectManager.getHeaderFunctionalityPage().waitAndClickOnAddCompanyFromHeaderUnderAddButton();
			} catch (Exception e) {
