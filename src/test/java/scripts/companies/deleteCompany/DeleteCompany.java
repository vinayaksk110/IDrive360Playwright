 ...
 */
package scripts.companies.deleteCompany;
...
public class DeleteCompany extends TestBase {
	...
	public DeleteCompany(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void startTest() {
		...
		logicForDeleteCompany();
	}

	public TestResultsStatus logicForDeleteCompany() {
		try {
			...
			try {
				...
				String errorMessage = "Error while asserting toast message for Delete company\n";
				System.out.println(errorMessage);
				ae.printStackTrace();
				testResultsStatus.setTestResult("Fail");
			...
			if (pageObjectManager.getCompaniesPage().trustPopup.isDisplayed()) {
				System.out.println("");
				String errorMessage = "Error while Deleting company, Device is not trusted, please trust this device first\n";
				System.out.println(errorMessage);
				e.printStackTrace();
				testResultsStatus.setTestResult("Fail");
				testResultsStatus.setTestResultComment(errorMessage + e.getMessage());
