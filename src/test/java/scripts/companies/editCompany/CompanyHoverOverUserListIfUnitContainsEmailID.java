...
public class CompanyHoverOverUserListIfUnitContainsEmailID extends TestBase {
	UserCredentials userCredentials = null;
	PageObjectManager pageObjectManager = null;
	WebDriver driver = null;
	Wait<WebDriver> wait = null;
		
	public CompanyHoverOverUserListIfUnitContainsEmailID() {
		
	}
	
	public CompanyHoverOverUserListIfUnitContainsEmailID(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(CompanyHoverOverUserListIfUnitContainsEmailID.class.getSimpleName());
	}
	...
	public void hoveroverUnitOption() {
		...
		pageObjectManager.getLhsOptionsPage().waitForManagementSectionAndClick(testResultsStatus);
            logicForCompanyHoverOverUserListIfUnitContainsEmailID();
		
	}

public TestResultsStatus logicForCompanyHoverOverUserListIfUnitContainsEmailID() {
	try {
		...
		wait.until(ExpectedConditions.visibilityOf(pageObjectManager.getUsersPage().lhsUSerOption));
			//wait- Added user will appear(List)
			wait.until(ExpectedConditions.visibilityOf(pageObjectManager.getUsersPage().userListappear));		
	} catch (Exception e) {
