...
public class EnableBackupPlanFromTopMenu extends TestBase{
	UserCredentials userCredentials = null;
	PageObjectManager pageObjectManager = null;
	WebDriver driver = null;
	Wait<WebDriver> wait = null;

	public EnableBackupPlanFromTopMenu() {

	}

	public EnableBackupPlanFromTopMenu(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(EnableBackupPlanFromTopMenu.class.getSimpleName());
	}
	...
	public void startTest() {
		...
		logicForEnableBackupPlan();
	}

	public TestResultsStatus logicForEnableBackupPlan() {
		pageObjectManager.getBackupPlanPage().selectBackupPlan(userCredentials.backupPlanName);
		pageObjectManager.getBackupPlanPage().EnableBackupPlan(testResultsStatus);
		String successMessage = pageObjectManager.getBackupPlanPage().waitForSuccessMessage();
		String ExpectedMessage = getMessage("backupplans.enableSuccMessage");
		try {
