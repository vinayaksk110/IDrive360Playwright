...
public class DeleteBackupPlanFromtopMenu extends TestBase {
	UserCredentials userCredentials = null;
	PageObjectManager pageObjectManager = null;
	WebDriver driver = null;
	Wait<WebDriver> wait = null;

	public DeleteBackupPlanFromtopMenu() {

	}

	public DeleteBackupPlanFromtopMenu(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(DeleteBackupPlanFromtopMenu.class.getSimpleName());
	}
	...
	public void startTest() {
		...
		logicForDeleteBackupPlan();
	}

	public TestResultsStatus logicForDeleteBackupPlan() {
		pageObjectManager.getBackupPlanPage().selectBackupPlan(userCredentials.backupPlanName);
		pageObjectManager.getBackupPlanPage().DeleteBackupPlan(testResultsStatus);
		String successMessage = pageObjectManager.getBackupPlanPage().waitForSuccessMessage();
		String ExpectedMessage = getMessage("backupplans.deleteSuccMessage");
		try {
		...
		pageObjectManager.getActivityLogsPage().AssertActivityLogs(getMessage("activitylogs.BackupPlanDeleted")
