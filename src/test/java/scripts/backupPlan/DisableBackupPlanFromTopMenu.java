...
public class DisableBackupPlanFromTopMenu extends TestBase {
	UserCredentials userCredentials = null;
	PageObjectManager pageObjectManager = null;
	WebDriver driver = null;
	Wait<WebDriver> wait = null;

	public DisableBackupPlanFromTopMenu() {

	}

	public DisableBackupPlanFromTopMenu(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		testResultsStatus.setTestName(DisableBackupPlanFromTopMenu.class.getSimpleName());
	}
	...
	public void startTest() {
		...
		logicForDisableBackupPlan();
	}
	
	public TestResultsStatus logicForDisableBackupPlan() {
		pageObjectManager.getBackupPlanPage().selectBackupPlan(userCredentials.backupPlanName);
		pageObjectManager.getBackupPlanPage().DisableBackupPlan(testResultsStatus);
		String successMessage = pageObjectManager.getBackupPlanPage().waitForSuccessMessage();
		String ExpectedMessage = getMessage("backupplans.disableSuccMessage");
		try {
