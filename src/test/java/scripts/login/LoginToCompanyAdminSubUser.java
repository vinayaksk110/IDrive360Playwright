...
public class LoginToCompanyAdminSubUser extends TestBase {
	...
	public LoginToCompanyAdminSubUser() {

	}

	public LoginToCompanyAdminSubUser(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	public void initializeTest(@Optional("yes") String excelFileStatus, @Optional("chrome") String browser,
		...
		try {
			...
			testResultsStatus.setTestName(LoginToCompanyAdminSubUser.class.getSimpleName());
	...
	public void runLoginTest() {
		...
		logicForLoginToCompanyAdminSubUser();
	...
	public void logicForLoginToCompanyAdminSubUser() {
		try {
			...
			testResultsStatus.setTestResultComment("Logged in to the Sub user: Company admin");
