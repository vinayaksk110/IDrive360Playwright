...
public class UnblockComputerFromSettings extends TestBase {
	UserCredentials userCredentials = null;
	PageObjectManager pageObjectManager = null;
	WebDriver driver = null;
	Wait<WebDriver> wait = null;
	
	public UnblockComputerFromSettings() {
		
	}
	
	public UnblockComputerFromSettings(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	@Test
	public void UnblockAComputerFromSettings() {
		...
		try {
			...
			wait.until(ExpectedConditions.visibilityOf(pageObjectManager.getComputerDevicePage().btnComputerUnblock));
			pageObjectManager.getComputerDevicePage().btnComputerUnblock.click();
			System.out.println("unblock computer button clicked");
			wait.until(ExpectedConditions.visibilityOf(pageObjectManager.getComputerDevicePage().btnunblock));
			pageObjectManager.getComputerDevicePage().btnunblock.click();
			System.out.println("button unblock clicked in the pop-up");
			...
			Assert.assertEquals(message, "Device DILEEPKUMARDAV has been unblocked.");
			testResultsStatus.setTestResultComment("Device has been unblocked");
