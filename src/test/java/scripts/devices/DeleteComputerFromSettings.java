...
public class DeleteComputerFromSettings extends TestBase{
	UserCredentials userCredentials = null;
	PageObjectManager pageObjectManager = null;
	WebDriver driver = null;
	Wait<WebDriver> wait = null;
	
	public DeleteComputerFromSettings() {
		
	}
	
	public DeleteComputerFromSettings(PageObjectManager pageObjectManager, WebDriver driver, Wait<WebDriver> wait,
	...
	@Test
	public void DeleteAComputerFromSettings() {
		...
		try {
			...
			wait.until(ExpectedConditions.visibilityOf(pageObjectManager.getComputerDevicePage().btnComputerDelete));
			pageObjectManager.getComputerDevicePage().btnComputerDelete.click();
			System.out.println("Delete computer clicked");
			wait.until(ExpectedConditions.visibilityOf(pageObjectManager.getComputerDevicePage().btnDelete));
			pageObjectManager.getComputerDevicePage().btnDelete.click();
			System.out.println("Delete button clicked in the pop-up");
			pageObjectManager.getComputerDevicePage().btnDelete.click();
			System.out.println("Final delete button clicked");
			testResultsStatus.setTestResultComment("Device has been deleted");
